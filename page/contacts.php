      ...
      <div class="container">
        <div class="row align-items-center justify-content-center">
          <div class="col col-12 col-lg-6 my-5">
            ...
            <ul>
              <li>
                <a href="mailto:tanngrisnir.asso@gmail.com" aria-label="mail"
                  ><i class="fa fa-envelope"> tanngrisnir.asso@gmail.com</i></a
                >
              </li>
              <li>
                <a
                  ...
                  ><i class="fa fa-instagram"></i> tanngrisnir_ofjarnfjall</a
                >
              </li>
              <li>
                <a
                  ...
                  rel="noopener noreferrer"
                  aria-label="Facebook"
                  ><i class="fa fa-facebook"></i> Tanngrisnir</a
                >
              </li>
              <li>
                <a href="tel:+33647501552">
                  <i class="fa fa-phone"></i> +33647501552</a
                >
              </li>
            </ul>
          </div>
          <div class="col col-12 col-lg-6 my-5">
            <img
              src="../ressource/images/contact1.jpg"
              alt="Troupe de viking"
              width="100%"
              height="auto"
            />
          </div>
